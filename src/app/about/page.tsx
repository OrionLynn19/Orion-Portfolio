                    ...
                    <div className="flex flex-col gap-8 sm:gap-12 md:gap-16 lg:grid lg:grid-cols-8 lg:gap-16 w-full">
                        ...
                        <div className="flex flex-col gap-8 sm:gap-10 md:gap-12 lg:col-span-3 lg:gap-0">
                            ...
                            <p className="font-medium leading-relaxed text-dark text-justify text-sm sm:text-base">
                                I’m a cloud‑driven  engineer with hands‑on experience in building scalable infrastructure, automating deployments, and supporting modern application workflows. My technical toolkit spans AWS, Kubernetes, Docker, Linux, and GitHub Actions, enabling me to design reliable CI/CD pipelines and containerized environments. I work with PostgreSQL for robust data modeling and use Next.js and Tailwind when full‑stack delivery is needed. I lead code reviews with a focus on security, performance, and maintainability, and I’m committed to building resilient, production‑ready systems that scale and deliver real impact
                            </p>
                        </div>
